...
- [bitonic_noidlethreads.cu](kernels/bitonic_noidlethreads.cu) - Optimized bitonic sort that eliminates idle threads using thread coarsening and bit manipulation
